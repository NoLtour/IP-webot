...
class Console:
    ...
    @staticmethod
    def get_version(pkg_name="simulation_zeroros"):
        """Returns pkg_name version number

        Parameters
        ----------
        pkg_name : str
            Name of the python package, by default 'simulation_zeroros'
        ...
        """
        return str(importlib_metadata.version(pkg_name))
    ...
    def set_logging_file(filename):
        ...
        if not folder_path.exists():
            Console.info("Creating folder: " + str(folder_path))
        ...
        if logger is not None:
            logger.info("simulation_zeroros version: " + Console.get_version())
